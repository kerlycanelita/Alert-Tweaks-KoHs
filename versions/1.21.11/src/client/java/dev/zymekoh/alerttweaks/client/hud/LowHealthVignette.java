...
public final class LowHealthVignette {
	...
	private static void draw(GuiGraphics graphics, AlertTweaksConfig config, int alpha, float sizeMultiplier) {
	...
	private static void drawSideFade(GuiGraphics graphics, AlertTweaksConfig config, int alpha, int width, int height, int edgeSize) {
