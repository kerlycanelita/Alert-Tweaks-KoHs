...
public final class ThreatIndicatorRenderer {
	 ...
	 */
	public static float effectiveScale(GuiGraphics graphics, AlertTweaksConfig config) {
	 ...
	 */
	public static void draw(GuiGraphics graphics, float centerX, float centerY, float relativeDegrees,
	...
	private static void blit(GuiGraphics graphics, Matrix3x2fStack pose, Identifier texture,
